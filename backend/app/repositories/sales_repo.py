...
async def find_one(restaurant_id: str, sale_id: str) -> Optional[Dict[str, Any]]:
	query = {"_id": ObjectId(sale_id), "restaurantId": restaurant_id}
...
async def delete_one(restaurant_id: str, sale_id: str) -> bool:
	query = {"_id": ObjectId(sale_id), "restaurantId": restaurant_id}
